...
const LibraryModule = () => {
  ...
  const fetchResources = useCallback(async () => {
    ...
    setError('');
    try {
      const res = await axios.get(API_BASE_URL + '/under-my-admin', { headers: getAuthHeaders() });
  ...
  const handleSaveResource = async (resourceData) => {
    ...
    try {
      if (editingResource && editingResource._id) {
        ...
        await axios.put(`${API_BASE_URL}/under-my-admin/${editingResource._id}`, resourceData, { headers: getAuthHeaders() });
      } else {
        // Add new resource
        await axios.post(API_BASE_URL + '/under-my-admin', resourceData, { headers: getAuthHeaders() });
      }
