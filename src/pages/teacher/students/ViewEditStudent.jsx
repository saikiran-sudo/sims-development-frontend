            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" name="admissionNo" value={formData.admissionNo} onChange={handleChange} readOnly={!editable}
                  className={`mt-1 block w-full border ${errors.admissionNo ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm p-2 ${!editable ? 'bg-gray-100' : ''}`} disabled={true} />
              ...
              <div>
                ...
                <input type="text" name="studentId" value={formData.studentId} onChange={handleChange} readOnly={!editable}
                  className={`mt-1 block w-full border ${errors.studentId ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm p-2 ${!editable ? 'bg-gray-100' : ''}`} disabled={true} />
              ...
              <div>
                ...
                {editable ? (
                  <Select
                    ...
                    value={getSelectValue(classOptions, formData.class)}
                  ...
                  <div className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 bg-gray-100">
                    {formData.class ? (
                      (() => {
                        ...
                        return selectedClass ? selectedClass.label : formData.class;
                      })()
                    ) : (
                      'No class assigned'
                    )}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Parent {editable && <span className="text-red-500">*</span>}</label>
                {editable ? (
                  <Select
                  ...
                  <div className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 bg-gray-100">
                    {formData.parent && formData.parent[0] ? (
                      (() => {
                        const selectedParent = parentOptions.find(option => String(option.value) === String(formData.parent[0]));
                        return selectedParent ? selectedParent.label : `User ID: ${formData.parent[0]}`;
                      })()
                    ) : (
                      'No parent assigned'
                    )}
