// src/pages/parent/components/Navbar.jsx
...
const Navbar = ({ isMobileMenuOpen, setIsMobileMenuOpen, onSearchNavigate }) => { // Accept onSearchNavigate prop
  ...
  const handleSearchSubmit = (e) => {
    ...
    if (onSearchNavigate) {
      onSearchNavigate(searchQuery); // Call the prop function
  ...
  return (
    <div className='flex items-center justify-between p-3 bg-white shadow-sm dark:bg-gray-800'>
      ...
      <div className="flex items-center gap-3 lg:hidden">
        ...
        <Link to="/parent" className="flex items-center gap-2"> {/* Link to /parent base */}
      ...
      <div className='flex items-center gap-4 sm:gap-6 ml-auto'>
        ...
        <div
          className='bg-gray-100 rounded-full w-8 h-8 flex items-center justify-center cursor-pointer relative hover:bg-gray-200'
          onClick={() => navigate('/parent/announcements/overview')}
        >
