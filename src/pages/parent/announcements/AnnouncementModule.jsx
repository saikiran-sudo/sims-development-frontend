  ...
  useEffect(() => {
    const fetchAnnouncements = async () => {
      ...
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/api/announcements/under-my-parent`, {
          headers: {
        ...
        const normalizedData = response.data.map((announcement) => ({
          ...announcement,
          ...
          target: Array.isArray(announcement.target) ? announcement.target.map(t => t.toLowerCase()) : [],
