...
import {
  ...
  Edit2, Save, Camera, XCircle, Eye, EyeOff, CheckCircle, Loader2 // Added Loader2 for loading states
} from 'lucide-react';
...
const ProfileModule = () => {
  ...
  // State for profile update functionality
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Make direct axios PUT request to backend
      const response = await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/api/admin-profile/${userId}`,
        updateData,
        { headers }
      );
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      // Make direct axios POST request to backend for password change
            ...
            <div className="bg-white border rounded-xl p-8 shadow-sm mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
                ...
                <div>
                  ...
                  {isEditing ? (
                    <input type="text" id="name" disabled name="name" value={profileData.name} onChange={handleInputChange} className="w-full border border-gray-300 px-4 py-2.5 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                  ) : (
                ...
                <div>
                  ...
                  {isEditing ? (
                    <input type="email" disabled id="email" name="email" value={profileData.email} onChange={handleInputChange} className="w-full border border-gray-300 px-4 py-2.5 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                  ) : (
                ...
                <div>
                  ...
                  {isEditing ? (
                    <input type="tel" disabled id="phone" name="phone" value={profileData.phone || ''} onChange={handleInputChange} className="w-full border border-gray-300 px-4 py-2.5 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                  ) : (
                    <div className="flex items-center gap-3 bg-gray-50 px-4 py-2.5 border border-gray-200 rounded-lg text-gray-800">
                ...
                <form onSubmit={handleChangePassword}>
                  ...
                  <div className="mt-8 flex justify-end gap-3">
                    <button
                      ...
                      className="px-5 py-2 rounded-lg bg-gray-200 text-gray-800 hover:bg-gray-300 transition focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      disabled={isChangingPassword}
                      className="flex items-center gap-2 px-5 py-2 rounded-lg bg-purple-700 text-white hover:bg-purple-800 transition focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isChangingPassword ? (
                        <>
