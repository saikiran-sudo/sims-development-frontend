...
const AddEditResourceModal = ({ initialData, onClose, onSave,admin_id }) => { // Removed classOptions prop
  ...
  useEffect(()=>{
    const fetchClasses = async () => {
      const response = await classAPI.getAllClasses();
        ...
        })).filter(opt => opt.value); // Remove any undefined/null values
          ...
          <div>
            ...
            <Select
              ...
              onChange={(selected) => setFormData({
                ...formData,
                classes: selected ? selected.map(opt => opt.value) : []
              })}
