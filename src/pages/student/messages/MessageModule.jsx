...
function MessageModule() {
  ...
  const handleSendDraft = (message) => {
    // Call the original handleSendMessage from the context with the draft message
    handleSendMessage({
    ...
    // Close the expanded view after sending
    setExpandedMessage(null);
    ...
    <div className="px-0 sm:px-2 md:px-4 lg:p-6 flex flex-col gap-2 sm:gap-4 lg:gap-8">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="bg-yellow-50 border border-yellow-200 rounded p-2 text-sm">
          <p>Debug: Active Tab: {activeTab}, Messages: {messages.length}, Filtered: {filteredMessages.length}</p>
      ...
      <div className='flex justify-between mb-4'>
        ...
        <div className='flex gap-2'>
          ...
          <button
            onClick={() => {
              setSelectedMessage(null); // Clear selected message for new compose
